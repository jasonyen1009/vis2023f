...
Plot.plot({
  ...
  marks: [
    ...
    // Plot.barY(yCounts, {x: "year", y: "count", sort: {x: "y", reverse: false}})
  ]
})
)}

function _9(md){return(
md`## 可調整margin, fill color,  tip (2pt)`
)}
...
Plot.plot({
  ...
  marks: [
    ...
    // Plot.barY(yCounts, {x: "year", y: "count", tip: true , fill:"gender", sort: {x: "y", reverse: false}})
